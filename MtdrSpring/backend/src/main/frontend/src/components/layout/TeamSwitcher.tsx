  ...
  const handleDelete = async (team: Team): Promise<void> => {
    ...
    try {
      ...
      const msg =
        ...
        'Failed to delete team (may have active tasks).'
      alert(msg)
    }
    setOpenMenuId(null)
  }
  ...
  const handleAddPeople = async (team: Team): Promise<void> => {
    ...
    try {
      ...
      const options = res.data
        .map((u) => `${u.userId}: ${u.username} (${u.email})`)
        .join('\n')
  ...
  return (
    <div className={styles.section} ref={menuRef}>
      <div className={styles.sectionHeader}>
        ...
        {isManager && (
          <button className={styles.addBtn} onClick={handleCreateTeam} aria-label="Create team">
            <IconPlus />
          </button>
        )}
      </div>
            ...
            <div className={styles.dotsWrap}>
              ...
              {openMenuId === team.id && (
                <div className={styles.contextMenu} role="menu">
                  ...
                  <button className={styles.menuItem} role="menuitem" onClick={() => handleRename(team)}>
                    <IconEdit /> Edit Name
                  </button>
                  <button
