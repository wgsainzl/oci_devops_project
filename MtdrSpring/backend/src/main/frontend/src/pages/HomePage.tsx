...
export default function HomePage(): JSX.Element {
    ...
    const safeHoursPerDev = Array.isArray(data.hoursPerDev)
        ? data.hoursPerDev
        : [];
    const safeSprintSummaries = Array.isArray(data.sprintSummaries)
        ? data.sprintSummaries
        : [];
    ...
    if (loading) {
        return (
            <LoadingPage
                title="Loading home"
                description="Fetching recent activity, stats, and team data."
            />
        );
    }
